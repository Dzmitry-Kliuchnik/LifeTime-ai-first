 ...
 */
export function formatDateLocale(date: Date, locale = 'en-US', options?: Intl.DateTimeFormatOptions): string {
 ...
 */
export function calculateTotalLifetimeWeeks(lifespanYears: number = DATE_CONSTANTS.DEFAULT_LIFESPAN): number {
 ...
 */
export function getWeekType(dateOfBirth: Date, weekIndex: number, referenceDate: Date = new Date()): WeekType {
